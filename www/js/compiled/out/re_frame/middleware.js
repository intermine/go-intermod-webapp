...
while (G__30173__i < G__30173__a.length) {G__30173__a[G__30173__i] = arguments[G__30173__i + 0]; ++G__30173__i;}
  args = new cljs.core.IndexedSeq(G__30173__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__30174){
...
return cljs.core.get_in.call(null,new_db,p1__30175_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__30176_SHARP_){
return cljs.core.get_in.call(null,db,p1__30176_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__30177__i = 0, G__30177__a = new Array(arguments.length -  2);
while (G__30177__i < G__30177__a.length) {G__30177__a[G__30177__i] = arguments[G__30177__i + 2]; ++G__30177__i;}
  in_paths = new cljs.core.IndexedSeq(G__30177__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__30178){
var f = cljs.core.first(arglist__30178);
arglist__30178 = cljs.core.next(arglist__30178);
var out_path = cljs.core.first(arglist__30178);
var in_paths = cljs.core.rest(arglist__30178);
...
//# sourceMappingURL=middleware.js.map?rel=1463388062163