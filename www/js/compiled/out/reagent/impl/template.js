...
var G__29883 = o;
(G__29883[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__29884__delegate = function (args){
...
while (G__29885__i < G__29885__a.length) {G__29885__a[G__29885__i] = arguments[G__29885__i + 0]; ++G__29885__i;}
  args = new cljs.core.IndexedSeq(G__29885__a,0);
} 
return G__29884__delegate.call(this,args);};
G__29884.cljs$lang$maxFixedArity = 0;
G__29884.cljs$lang$applyTo = (function (arglist__29886){
var args = cljs.core.seq(arglist__29886);
return G__29884__delegate(args);
});
...
var G__29891 = jsprops;
(G__29891["defaultValue"] = value);

(G__29891["onChange"] = ((function (G__29891,v,value,on_change){
return (function (p1__29889_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29889_SHARP_);
});})(G__29891,v,value,on_change))
);
...
var vec__29896 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29896,(0),null);
var id = cljs.core.nth.call(null,vec__29896,(1),null);
var class$ = cljs.core.nth.call(null,vec__29896,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___29899 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___29899 == null)){
} else {
var key_29900 = temp__4429__auto___29899;
(jsprops["key"] = key_29900);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__29902 = (new reagent.impl.template.NativeWrapper());
(G__29902["name"] = c);
...
var len__17863__auto___29908 = arguments.length;
var i__17864__auto___29909 = (0);
while(true){
if((i__17864__auto___29909 < len__17863__auto___29908)){
args__17870__auto__.push((arguments[i__17864__auto___29909]));

var G__29910 = (i__17864__auto___29909 + (1));
i__17864__auto___29909 = G__29910;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29906){
var G__29907 = cljs.core.first.call(null,seq29906);
var seq29906__$1 = cljs.core.next.call(null,seq29906);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29907,seq29906__$1);
});
...
break;
default:
var G__29914 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29914;
continue;
...
var n__17708__auto___29915 = a.length;
var i_29916 = (0);
while(true){
if((i_29916 < n__17708__auto___29915)){
(a[i_29916] = reagent.impl.template.as_element.call(null,(a[i_29916])));
...
var a = cljs.core.into_array.call(null,s);
var n__17708__auto___29918 = a.length;
var i_29919 = (0);
while(true){
if((i_29919 < n__17708__auto___29918)){
var val_29920 = (a[i_29919]);
if((cljs.core.vector_QMARK_.call(null,val_29920)) && ((reagent.impl.template.key_from_vec.call(null,val_29920) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29919] = reagent.impl.template.as_element.call(null,val_29920));
...
var ctx = {};
var vec__29923 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29923,(0),null);
var derefed = cljs.core.nth.call(null,vec__29923,(1),null);
...
var G__29925 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29925) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29925){
...
//# sourceMappingURL=template.js.map?rel=1463388061565