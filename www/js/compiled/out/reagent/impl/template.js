...
var G__22163 = o;
(G__22163[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__22165__i < G__22165__a.length) {G__22165__a[G__22165__i] = arguments[G__22165__i + 0]; ++G__22165__i;}
  args = new cljs.core.IndexedSeq(G__22165__a,0);
} 
...
var G__22171 = jsprops;
(G__22171["defaultValue"] = value);

(G__22171["onChange"] = ((function (G__22171,v,value,on_change){
return (function (p1__22169_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22169_SHARP_);
});})(G__22171,v,value,on_change))
);
...
var vec__22176 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22176,(0),null);
var id = cljs.core.nth.call(null,vec__22176,(1),null);
var class$ = cljs.core.nth.call(null,vec__22176,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___22179 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___22179 == null)){
} else {
var key_22180 = temp__4429__auto___22179;
(jsprops["key"] = key_22180);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__22182 = (new reagent.impl.template.NativeWrapper());
(G__22182["name"] = c);
...
var len__17863__auto___22188 = arguments.length;
var i__17864__auto___22189 = (0);
while(true){
if((i__17864__auto___22189 < len__17863__auto___22188)){
args__17870__auto__.push((arguments[i__17864__auto___22189]));

var G__22190 = (i__17864__auto___22189 + (1));
i__17864__auto___22189 = G__22190;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22186){
var G__22187 = cljs.core.first.call(null,seq22186);
var seq22186__$1 = cljs.core.next.call(null,seq22186);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__22187,seq22186__$1);
});
...
break;
default:
var G__22194 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22194;
continue;
...
var n__17708__auto___22195 = a.length;
var i_22196 = (0);
while(true){
if((i_22196 < n__17708__auto___22195)){
(a[i_22196] = reagent.impl.template.as_element.call(null,(a[i_22196])));
...
var a = cljs.core.into_array.call(null,s);
var n__17708__auto___22198 = a.length;
var i_22199 = (0);
while(true){
if((i_22199 < n__17708__auto___22198)){
var val_22200 = (a[i_22199]);
if((cljs.core.vector_QMARK_.call(null,val_22200)) && ((reagent.impl.template.key_from_vec.call(null,val_22200) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22199] = reagent.impl.template.as_element.call(null,val_22200));

var G__22201 = (i_22199 + (1));
i_22199 = G__22201;
continue;
} else {
}
...
var ctx = {};
var vec__22203 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22203,(0),null);
var derefed = cljs.core.nth.call(null,vec__22203,(1),null);
...
var G__22205 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22205) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22205){
...
//# sourceMappingURL=template.js.map?rel=1462895593646